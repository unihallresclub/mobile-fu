  ...
  module MobileFu
    ...
    module InstanceMethods
      ...
      def set_mobile_format
        if request.format.html? && (params[:format].nil? || params[:format] == 'mobile') && !mobile_exempt? && is_mobile_device? && !request.xhr?
          request.format = :mobile unless session[:mobile_view] == false
          session[:mobile_view] = true if session[:mobile_view].nil?
        elsif request.format.html? && (params[:format].nil? || params[:format] == 'tablet') && !mobile_exempt? && is_tablet_device? && !request.xhr?
